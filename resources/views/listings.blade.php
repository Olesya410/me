...
@section('content')
<div class="wrapper">
    <div class="search-section" style="background: #020f46;">
    <form method="GET" action="{{ route('listings.index') }}" class="d-flex align-items-center p-3 rounded" id="searchForm" style="gap: 15px;">
            <!-- Минимальная цена -->
            <div class="form-group d-flex flex-column" style="min-width: 250px;">
            ...
            <div class="form-group d-flex flex-column" style="min-width: 250px;">
                ...
                <input type="text" name="city" value="{{ old('city', $filterData['city'] ?? '') }}"
            ...
            <!-- Кнопка -->
            <button class="btn btn-primary d-flex align-items-center justify-content-center" style="height: 38px; padding: 0 20px;">
