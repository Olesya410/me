...
<body class="bg-light">
    <style>
        /* Общий стиль для блоков городов, делая их одинаковой ширины */
        .city-block {
            width: 100%; /* или max-width: 600px; для ограничения ширины */
            max-width: 600px;
            margin: 0 auto 20px auto; /* Центрировать и отступ снизу */
        }
    </style>
    <div class="wrapper">
